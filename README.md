...
5. Jelaskan bagaimana cara kamu mengimplementasikan checklist di atas secara step-by-step (bukan hanya sekadar mengikuti tutorial).
    ...
    ck4 (deployment): Pertama-tama saya menambahkan django environ pada berkas requirements.txt dan melakukan perintah pada cmd untuk menginstal perubahan. Kemudian, saya membuat berkas file Procfile, folder .github, subfolder workflows, dan berkas pcp-deploy.yml. Kemudian, saya membuat berkas baru bernama .dockerignore dan Dockerfile. Selanjutnya, saya menambahkan import environ, kode secret key, databases, dan static url pada file settings. Terakhir, saya menambahkan beberpa repository secret pada github berupa DOKKU_SERVER_IP, DOKKU_APP_NAME, dan DOKKU_SSH_PRIVATE_KEY.
...
1. Jelaskan manfaat dari setiap element selector dan kapan waktu yang tepat untuk menggunakannya.
    ...
    - Element selector dapat digabung dengan selector lain sehingga fleksibilitas pemrograman lebih tinggi.
...
4. Jelaskan perbedaan antara framework CSS Tailwind dan Bootstrap. Kapan sebaiknya kita menggunakan Bootstrap daripada Tailwind, dan sebaliknya?
    ...
    - Karena gaya didefinisikan dalam HTML, Tailwaind akan terlihat lebih padat dan sedikit berantakan dibandingkan Bootstrap yang mendefinisikan gaya pada kelas CSS terpisah.
...
5. Jelaskan bagaimana cara kamu mengimplementasikan checklist di atas secara step-by-step (bukan hanya sekadar mengikuti tutorial).
    ...
    ck(bonus) : Saya menambahkan style css pada berkas main.html. Saya membuat style table tr : last-child untuk mengubah warna background dari item terakhir yang di tambahkan ke inventori dan tabel tr : last-child td untuk mengubah warna teks/isi baris terakhir tabel / item terakhir yang ditambahkan.
